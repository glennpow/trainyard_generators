class TrainyardScaffoldGenerator < Rails::Generator::Base
  ...
  def initialize(runtime_args, runtime_options = {})
    ...
    if @attributes.empty?
      ...
      if model_exists?
        ...
        @attributes << Rails::Generator::GeneratedAttribute.new('description', 'text')
        @attributes << Rails::Generator::GeneratedAttribute.new('name', 'string')
        @attributes << Rails::Generator::GeneratedAttribute.new('name', 'string')
      end
    end
...
protected
  ...
  def add_options!(opt)
    ...
    opt.on("--child", "This model is the child of a parent resource.") { |v| options[:child] = v }
    opt.on("--image", "Add an image to this model.") { |v| options[:image] = v }
  end
